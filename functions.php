...
if(!function_exists('xyz_setup')) {
    function xyz_setup() {
        ...
        add_image_size('image_300x300', 300, 300, true);
		register_nav_menus(
			array(
